<template>
  <div>
    <div class="sdc-rounded-t sdc-bg-gray-400 sdc-p-2 sdc-flex sdc-justify-start sdc-items-center">
      <img class="sdc-pr-1" src="https://www.edutheque.fr/apple-touch-icon.png" style="height:24px" />
      <h2>{{ title }}</h2>
    </div>
...
<script>
import * as Edutheque from '../search_engines/edutheque';
...
export default {
  ...
  computed: {
    title: function() {
      return `Eduthèque - ${this.results.length} résultats`;
    },
